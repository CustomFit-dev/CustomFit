...
class ProductosPersonalizadosSerializer(serializers.ModelSerializer):
    ...
    # Campo personalizado para compatibilidad con frontend (traduce urlEspadarl -> urlEspaldar)
    urlEspaldar = serializers.SerializerMethodField()
    tela_nombre = serializers.SerializerMethodField()
    ...
    def get_tela_nombre(self, obj):
        if obj.telaid:
            return obj.telaid.NombreTela
        return "Desconocida"
...
class PedidoItemSerializer(serializers.ModelSerializer):
    ...
    producto_personalizado_detail = serializers.SerializerMethodField()

    class Meta:
        model = PedidoItem
        fields = ['id', 'producto', 'producto_personalizado', 'producto_personalizado_detail', 'producto_nombre', 'producto_imagen', 'cantidad', 'precio', 'subtotal']
    ...
    def get_producto_personalizado_detail(self, obj):
        if obj.producto_personalizado:
            return ProductosPersonalizadosSerializer(obj.producto_personalizado).data
        return None
...
class PedidoSerializer(serializers.ModelSerializer):
    ...
    usuario_email = serializers.CharField(source="usuario.correo_electronico", read_only=True)
    usuario_telefono = serializers.CharField(source="usuario.celular", read_only=True)
